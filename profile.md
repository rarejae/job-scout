...
## Who
Senior technology consultant (Big 4, ~2.5 yrs) — security/controls and Oracle ERP
implementations. Co-built internal agentic products: an ERP security automation
tool, an agentic assessment-questionnaire agent, a Copilot Studio context agent.
...
interest. Chicago-based; open to NYC; remote preferred over relocation elsewhere.
